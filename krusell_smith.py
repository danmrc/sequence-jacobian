...
@het(exogenous = 'Pi',policy = 'a', backward = 'V_prime_new', backward_init=household_guess)
def household(V_prime,a_grid,e_grid,r,w,beta,gamma,init = household_guess):
    c_prime = (beta*V_prime)**(-1/gamma)
    ...
    c = wel - a
    V_prime_new = (1+r)*c**(-gamma)

    return V_prime_new,a,c
